echo "=================================================================="
echo "CRYPTOSH Astrum MN Install"
echo "=================================================================="
...
wget https://github.com/thiagokroger/cryptosh/raw/master/compiled/astrum.tar.gz

tar -zxvf astrum.tar.gz
sudo cp astrum/astrumd /usr/local/bin/
...
echo "making genkey..."
GENKEY=$(astrumd masternode genkey)

echo "mining info..."
astrumd getmininginfo
astrumd stop
...
echo "astrumd getmininginfo:"
astrumd getmininginfo

echo "masternode status:"
astrumd masternode status

echo "INSTALLED WITH VPS IP: $WANIP:25117"
sleep 1
